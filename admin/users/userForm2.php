        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <a href="vetuserList.php" class="normal-link1" style="margin-bottom: 5px;">
                    ...
                    <form class="form" action="userForm.php" method="post" enctype="multipart/form-data">
                        <?php if ($isEditing === true) : ?>
                            <h2 class="text-center">Update Vet user</h2>
                        <?php else : ?>
                            <h2 class="text-center">Create Vet user</h2>
                        <?php endif; ?>
                        <hr><br><br>
                        ...
                        <div class="btn-cont">
                            ...
                            <?php else : ?>
                                <button type="submit" name="save_user2" class="btn btn-success btn-block btn-lg">Save user</button>
                            <?php endif; ?>
                        </div>
                    </form>
                </div>
