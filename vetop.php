...
<div class="container">
    ...
    <?php
    echo "<div class='centered'><img src='image_avatar2.png' alt='Avatar man'><h2><a href='operation.php?date=" . $date . "&vet=" . $vet1 . "' class='normal-link1'>Vet 1</a></h2>";
    ...
    echo "<div class='centered'><img src='image_avatar.png' alt='Avatar woman'><h2><a href='book.php?date=" . $date . "&vet=" . $vet2 . "' class='normal-link1'>Vet 2</a></h2>";
